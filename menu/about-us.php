  ...
  <section id="team">
    <div class="container" data-aos="fade-up">
      <div class="section-header">
        ...
        <p>Conoce parte de nuestro equipo: </p>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6" data-aos="zoom-out" data-aos-delay="100">
          <div class="member">
            <img src="../assets/img/Emerson.jpg" class="img-fluid" alt="">
        ...
        <div class="col-lg-3 col-md-6" data-aos="zoom-out" data-aos-delay="200">
          <div class="member">
            <img src="../assets/img/Dulce.jpg" class="img-fluid" alt="">
            <div class="member-info">
              <div class="member-info-content">
                <h4>Dulce Sanchez</h4>
        ...
        <div class="col-lg-3 col-md-6" data-aos="zoom-out" data-aos-delay="300">
          <div class="member">
            <img src="../assets/img/denis.jpg" class="img-fluid" alt="">
            <div class="member-info">
              <div class="member-info-content">
                <h4>Denis Garcia</h4>
  ...
  <section id="team">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6" data-aos="zoom-out" data-aos-delay="100">
          <div class="member">
            <img src="../assets/img/Fernando.png" class="img-fluid" alt="">
            <div class="member-info">
              <div class="member-info-content">
        ...
        <div class="col-lg-3 col-md-6" data-aos="zoom-out" data-aos-delay="200">
          <div class="member">
            <img src="../assets/img/Edith.png" class="img-fluid" alt="">
            <div class="member-info">
              <div class="member-info-content">
                <h4>Edith Toledo</h4>
        ...
        <div class="col-lg-3 col-md-6" data-aos="zoom-out" data-aos-delay="400">
          <div class="member">
            <img src="../assets/img/Diego.jpg" class="img-fluid" alt="">
            <div class="member-info">
              <div class="member-info-content">
                <h4>Diego Molina</h4>
