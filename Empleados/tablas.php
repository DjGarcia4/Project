    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!--Estado-->
          <form class="d-none d-sm-inline-block form-  mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
...
function buscar_datos(sql) {
  $.ajax({
      type: "POST",
      url: "filtroEmp.php?idUsuario=<?php echo $Usuario ?>&Empresas_idEmpresas=<?php echo $Empresa ?>",
      data: {
        sql: sql
      },
      dataType: "html",
...
function buscar_estado(point) {
  $.ajax({
      type: "POST",
      url: "filtroEmp.php?idUsuario=<?php echo $Usuario ?>&Empresas_idEmpresas=<?php echo $Empresa ?>&state=" +
        state + "",
      data: {
        point: point
      },
