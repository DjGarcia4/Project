        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-none d-sm-inline-block  mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="formulario__grupo" id="grupo__direccion">
              <select class="custom-select form-control" name="estado_Ciudad" id="estado_Ciudad"
...
function buscar_estado(point) {
  $.ajax({
      type: "POST",
      url: "filtroCiudades.php?idUsuario=<?php echo $Usuario ?>&Empresas_idEmpresas=<?php echo $Empresa ?>&state=" +
        state + "",
      data: {
        point: point
      },
