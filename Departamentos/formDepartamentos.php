                      ...
                      <form class="formulario" action=<?php if ($action == 1) {
                        ...
                        <div class="formulario__grupo" id="grupo__DescripcionDepto">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="DescripcionDepto" id="DescripcionDepto"
                              title="Modifica nombre del departamento"
                              <?php if ($action != 1 && $action != 2) echo "readonly" ?>
                              onkeypress="return soloLetras(event)" onblur="upperCase('DescripcionDepto')"
                          ...
                          <p class="formulario__input-error">La descripción del nombre del departamento solo acepta
                            letras y el máximo son 30.</p>
                        </div>
                        <!--Grupo: Estado-->
                        <div class="formulario__grupo" id="grupo__estado">
                          ...
                          <div class="formulario__grupo">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                              <input type="radio" name="Estados_idEstado" title="Selecciona si esta activo"
                        ...
                        <div class="formulario__grupo formulario__grupo-btn-enviar">
                          <div class="col-sm-6 mb-3 mb-sm-0" style=" width: 50vw; margin-left : 0vw;">
                            <a title="Click si no desea hacer ni una acción"
                              href="TablaDepartamentos.php?idUsuario=<?php echo $Usuario ?>&Empresas_idEmpresas=<?php echo $Empresa ?>"
