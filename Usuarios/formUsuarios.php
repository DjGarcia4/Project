                      ...
                      <form class="formulario" action=<?php if ($action == 1) {
                        ...
                        <div class="formulario__grupo" id="grupo__Usuario">
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="NombreUsuario" id="Usuario"
                              title="Ingresa nombre de Usuario"
                              <?php if ($action != 1 && $action != 2) {
                                                                                                                                                echo 'readonly';
                                                                                                                                              } ?>
                              onblur="upperCase('Usuario')" placeholder="Nombre del Usuario"
                        ...
                        <div class="formulario__grupo" id="grupo__Empleado_idEmpleados">
                          ...
                          <select class="formulario__input" name="Empleado_idEmpleados" id="Empleado_idEmpleados"
                            ...
                            ?>
                            <option value="<?php echo $ex['idEmpleados'] ?>"
                              <?php if (isset($row)) if ($row['Empleados_idEmpleados'] == $ex['idEmpleados'])  echo "selected" ?>>
